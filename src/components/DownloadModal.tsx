        ...
        <div className="p-8 space-y-6 text-left">
          <div className="space-y-2">
            <h2 className="text-2xl md:text-3xl font-black uppercase tracking-tighter leading-none text-[color:var(--text-color)]">
              Download <span className="text-blue-600">{project?.title}</span>?
            </h2>
          ...
          <div className="pt-4 space-y-4">
            ...
            <button 
              onClick={onClose}
              className="w-full text-[10px] font-black uppercase text-[color:var(--text-color)]/40 hover:text-blue-600 transition-all"
            >
              [ Cancel Request ]
            </button>
          </div>
