  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setProgress((prev) => {
        ...
        // Random increment to make it look like real processing
        const increment = Math.floor(Math.random() * 15) + 5;
        return Math.min(prev + increment, 100);
      });
    }, 200); // Speed of the counter updates
    ...
    <div className="fixed inset-0 z-[200] bg-[#050505] flex flex-col items-center justify-center font-mono text-[#A8E6A0] p-6 overflow-hidden">
      ...
      <div className="mb-10 flex flex-col items-center gap-2 text-center">
        ...
        <h2 className="text-2xl md:text-4xl font-black uppercase tracking-tighter">
          Establishing<span className="text-white">_CIPJ</span><span className="text-pink-500">.Core</span>
        </h2>
      </div>
